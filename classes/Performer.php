...
abstract class Performer
{
	 ...
	 */
	protected function cancel(string|null $message = null, bool $public = false, array|bool $log = true): void
	{
	 ...
	 */
	protected function silentCancel(string|null $message = null, array|bool $log = true): void
	{
		throw new PerformerException(
			performer: $this,
			message: $message,
