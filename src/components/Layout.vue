...
Keep in mind that this component is heavily affected by any Core changes if they happen and
so it's important to keep an eye on the core changes and update this component accordingly.
https://github.com/getkirby/kirby/blob/main/panel/src/components/Forms/Layouts/Layout.vue

This also means that the plugin does not work if any other plugin modifies the layout component as well.
We can solve this by creating an entire custom field similar to https://github.com/tobimori/kirby-icon-field.
